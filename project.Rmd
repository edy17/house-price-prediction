...
subtitle : "Advanced Regression Techniques in R"
author : 'EDY DIEHL TCHEUTCHOA DEFFO'
...
Les modèles de régression régularisés sont plus performants que le modèle de régression linéaire. Dans l'ensemble, tous les modèles fonctionnent bien avec des valeurs R-carré décentes et des valeurs RMSE stables. Néanmoins, nous aurons pu les améliorer avec des traitements plus poussés sur les méthodes de selection de variable pertinente et d'optimisation de modèle. Le résultat le plus idéal serait une valeur RMSE de zéro et une valeur R au carré de 1, mais c'est presque impossible dans les ensembles de données réelles et non pratique pour des prédictions généralisantes.
